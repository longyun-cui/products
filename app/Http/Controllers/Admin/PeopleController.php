...
use App\Repositories\Admin\PeopleRepository;
...
//        $this->service = new ProductService;
        $this->repo = new PeopleRepository;
    }
    ...
    {
        if(request()->isMethod('get')) return view('admin.people.list');
    ...
    // 列表
    public function view_people_product_list()
    {
        return $this->repo->view_people_product(request()->all());
    }
