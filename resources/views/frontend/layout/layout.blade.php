...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/')}}" class="logo" style="background-color:#222d32;text-align:left;">
            ...
            <span class="logo-lg"><b>作品集</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview {{ $people_active or '' }}">
                    <a href="{{url('/peoples')}}"><i class="fa fa-list text-orange"></i> <span>人物集</span></a>
                </li>

                <li class="treeview {{ $product_active or '' }}">
                    <a href="{{url('/products')}}"><i class="fa fa-table text-blue"></i> <span>作品集</span></a>
                </li>
