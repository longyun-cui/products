                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown tasks-menu add-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header"><a href="{{url('/home/table/create')}}"><i class="fa fa-circle-o text-red"></i>添加表格</a></li>
...
{{--                            <span class="hidden-xs">{{Auth::guard('admin')->user()->nickname or ''}}</span>--}}
                        </a>
                        <ul class="dropdown-menu">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    {{--<p>{{Auth::guard('admin')->user()->nickname or ''}}</p>--}}
                    <!-- Status -->
